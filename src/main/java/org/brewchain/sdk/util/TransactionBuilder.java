...
import org.brewchain.sdk.model.Transaction.TransactionBody;
import org.brewchain.sdk.model.Transaction.TransactionInfo;
import org.brewchain.sdk.model.Transaction.TransactionOutput;
...
//        log.debug("签名前==》\n{}",new JsonFormat().printToString(ti.build()));
        ti.setSignature(ByteString
                .copyFrom(
                        LocalCrypto.getInstance().sign(pb.getPrivateKey(),tb.build().toByteArray())
